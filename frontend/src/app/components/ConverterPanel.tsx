          ...
          >
            ...
            {(currentSql && userRole.toLowerCase() === 'admin') && (
              ...
              <div className="flex-1 p-6 overflow-auto bg-slate-900 dark:bg-[#0d0d0f] relative min-h-[200px]">
                <pre className="font-mono text-[13px] leading-relaxed text-slate-700 dark:text-zinc-300">
                    ...
                    <pre className="font-mono text-xs leading-relaxed text-slate-600 dark:text-zinc-400 space-y-1">
                      {serverLogs.map((log, i) => (
                        <div key={i}>
                          ...
                          <span className={log.includes('✅') ? 'text-emerald-400' : log.includes('❌') || log.includes('⚠️') ? 'text-rose-400' : 'text-slate-700 dark:text-zinc-300'}>
                            {log}
                          </span>
                        </div>
                      ))}
